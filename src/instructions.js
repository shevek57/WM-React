    ...
    return (
        <div>
            ...
            while remembering a series of letters.  Throughout the study you will receive feedback on your performance, such as the number of correctly
                verified statements and the number of letters correctly recalled.</p><br /><br />
            ...
            <ul><li>Practice 1: Letter recall practice</li>
                ...
                <li>Experiment: Combined statement judgments and letter recall</li></ul><br /><br />
            ...
            <p className="instrp">If you have any questions, please e-mail Irvin Katz at: <a href="mailto:ikatz@ets.org">ikatz@ets.org</a>. </p><br /><br />


            <p className="instrp">Please enter your assigned ID and click the "Start" button. Be sure to double-check your ID before you click "Start".  </p><br /><br />

            <p className="instrp">ID: <input type="text" defaultValue="" id="userid" size="20" ref={userID} /></p>
            <p className="bp"><button onClick={() => props.onDone(userID.current.value)}>Click to Start</button> </p>
        </div>
...
export function ExperimentInstructions(props) {
    return (<div>				<h1>Experiment Session</h1>
        ...
        <p className="bp"><button onClick={props.onDone}>Click to Start</button></p></div>)
}
